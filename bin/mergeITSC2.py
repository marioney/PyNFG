...
new_pose = np.array([west, 4])
starting_poses = np.vstack((starting_poses, new_pose))  # axis=0))
pose_ind = 0
while pose_ind < nr_vehicles - 2:
    new_pose = np.array([1, pose_ind * 2])
    starting_poses = np.vstack((starting_poses, new_pose))  # axis=0))
    pose_ind += 1
...
N = 500
mcrl_params = mcrl_dict(G, 2, np.linspace(1000, 1, N), N, 1, np.linspace(.5, 1, N),
...
print 'Training: Dcar0 at level 2'
#MCRL_solved.train_node('Dcar0', 2, setCPT=True)
#
# for index_node in range(nr_vehicles):
#     car_name = 'Dcar' + str(index_node)
...
store_game(MCRL_solved.Game, 'Game_stored_4iprand.pickle')

#
# valuedict = G.sample_timesteps(G.starttime, G.endtime, basenames=['Root', 'F',
#                                                                   'Ocar0', 'Ocar1', 'Ocar2', 'Ocar3', 'Ocar4',
#                                                                   'Ccar0', 'Ccar1', 'Ccar2', 'Ccar3', 'Ccar4',
#                                                                   'EOcar0', 'EOcar1', 'EOcar2', 'EOcar3','EOcar4',
#                                                                   'Dcar0', 'Dcar1', 'Dcar2', 'Dcar3', 'Dcar4'])
...
#     print '\n Time step ' + str(time_index)
#     print 'Observation CAR 0 : ' + str(valuedict['Ocar0'][time_index])
#     print 'Estimated action CAR 0: ' + str(valuedict['Ccar0'][time_index])
#     print 'Observation CAR 1: ' + str(valuedict['Ocar1'][time_index])
#     print 'Estimated action CAR 1: ' + str(valuedict['Ccar1'][time_index])
#     print 'Observation CAR 2: ' + str(valuedict['Ocar2'][time_index])
#     print 'Estimated action CAR 2: ' + str(valuedict['Ccar2'][time_index])
#     print 'Observation CAR 3: ' + str(valuedict['Ocar3'][time_index])
#     print 'Estimated action CAR 3: ' + str(valuedict['Ccar3'][time_index])
#     print 'Observation CAR 4: ' + str(valuedict['Ocar4'][time_index])
#     print 'Estimated action CAR 4:' + str(valuedict['Ccar4'][time_index])
#     print '\nEstimated Observation CAR 0: ' + str(valuedict['EOcar0'][time_index])
#     print 'Decision CAR 0: ' + str(valuedict['Dcar0'][time_index])
#     print '\nEstimated Observation CAR 1: ' + str(valuedict['EOcar1'][time_index])
#     print 'Decision CAR 1: ' + str(valuedict['Dcar1'][time_index])
#     print '\nEstimated Observation CAR 2: ' + str(valuedict['EOcar2'][time_index])
#     print 'Decision CAR 2: ' + str(valuedict['Dcar2'][time_index])
#     print '\nEstimated Observation CAR 3: ' + str(valuedict['EOcar3'][time_index])
#     print 'Decision CAR 3: ' + str(valuedict['Dcar3'][time_index])
#     print '\nEstimated Observation CAR 4: ' + str(valuedict['EOcar4'][time_index])
#     print 'Decision CAR 4: ' + str(valuedict['Dcar4'][time_index])
#     print 'New State'
...
def captures(G):
    ...
    T = G.endtime
    G.sample()
    num_captures = G.npv_reward('car3', T0, 1)
